                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                ...
                                <div class="carousel-item rounded">
                                    ...
                                    <a href="#products" class="btn px-4 py-2 text-white rounded">Vesitables</a>
                                </div>
                            </div>
            ...
            <div class="container py-5">
                <div class="tab-class text-center">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-8 text-end">
                            <ul class="nav nav-pills d-inline-flex text-center mb-5">
                                ...
                                <li class="nav-item">
                                    <a class="d-flex py-2 m-2 bg-light rounded-pill" data-bs-toggle="pill" href="#{{$section->category}}">
                    ...
                    <div class="tab-content">
                                ...
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="border border-secondary rounded overflow-hidden h-100">
                                            <div class="rounded position-relative fruite-item">
                                                <div class="fruite-img">
                                                    <img src="{{ asset('uploads/products/'.$item->image)}}" class="img-fluid w-100 rounded-top"  style="height: 250px; object-fit: cover;" alt="">
                                                </div>
                        ...
                        <div id="{{ $category->category }}" class="tab-pane fade show p-0">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row g-4">
                                        @if(isset($products[$category->category]))
                                         @if ($products[$category->category]->isEmpty())
                                            <div class="col-12 text-center py-5">
                                                <h5 class="text-muted">No products available</h5>
                                            </div>                                            
                                        @else
                                        @foreach ($products[$category->category] as $item)    
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="#">
                            <div class="service-item bg-secondary rounded border border-secondary">
                                <img src="{{ asset('theme/img/featur-1.jpg')}}" class="img-fluid rounded-top w-100" alt="">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="#">
                            <div class="service-item bg-dark rounded border border-dark">
                                <img src="{{ asset('theme/img/featur-2.jpg')}}" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="#">
                            <div class="service-item bg-primary rounded border border-primary">
                                <img src="{{ asset('theme/img/featur-3.jpg')}}" class="img-fluid rounded-top w-100" alt="">
                                <div class="px-4 rounded-bottom">
                ...
                <div class="owl-carousel vegetable-carousel justify-content-center">
                    ...
                    <div class="border border-primary rounded position-relative vesitable-item">
                        <div class="vesitable-img">
                            <img src="{{ asset('uploads/products/'.$vegetable->image)}}" class="img-fluid w-100 rounded-top" alt="">
                        </div>
                        ...
                        <div class="position-relative">
                            ...
                            <div class="d-flex align-items-center flex-nowrap">
                                <div class="bg-secondary rounded">
                                    <img src="{{ asset('theme/img/testimonial-1.jpg')}}" class="img-fluid rounded" style="width: 100px; height: 100px;" alt="">
                                </div>
